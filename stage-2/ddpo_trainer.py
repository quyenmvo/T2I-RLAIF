...
class DDPOTrainer(BaseTrainer):
    ...
    def step(self, epoch: int, global_step: int):
        ...
        self.plot_reward_by_epoch("reward_curves.png")
    ...
    def plot_reward_by_epoch(self, filename):
        epochs = range(1, len(self.reward_list) + 1)
        plt.plot(epochs, self.reward_list, 'b', label='Reward')
        plt.title('Human preference score')
        plt.xlabel('Epoch')
        plt.ylabel('Reward')
        plt.legend()
